...
for i in range(1, T+1):
    ...
    while possible and (c <= min_c or m <= min_m or y <= min_y or k <= min_k):
        ...
        c = (c + 1) if start[0] == 0 and c < min_c else c
        if c + m + y + k == 1000000:
             break

        m = (m + 1) if start[1] == 0 and m < min_m else m
        if c + m + y + k == 1000000:
             break

        y = (y + 1) if start[2] == 0 and y < min_y else y
        if c + m + y + k == 1000000:
             break

        k = (k + 1) if start[3] == 0 and k < min_k else k 
        if c + m + y + k == 1000000:
             break
